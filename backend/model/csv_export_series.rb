class CsvExportSeries < CsvExport
  ...
  def columns
    [
      ...
      Column.new('No of Significant Items (Memory of the World)', proc{|record| record.number_of_signicant_items_mow}),
      Column.new('No of Significant Items (Iconic)', proc{|record| record.number_of_signicant_items_iconic}),
      Column.new('No of Significant Items (High)', proc{|record| record.number_of_signicant_items_high}),
